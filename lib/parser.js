...
const mKontakt = require('./parser-kontakt.js');
...
BeaconParser.prototype.parse = function(peripheral) {
	...
	} else if(beacon_type === 'kontaktTelemetry'){
		parsed = mKontakt.parse(peripheral)
	}
...
BeaconParser.prototype._detectBeaconType = function(peripheral) {
	...
	// Kontakt Telemetry
	if (ad.serviceData.length > 0 && ad.serviceData[0].uuid === 'fe6a'){
